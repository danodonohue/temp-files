// Alaska Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Alaska Voting Districts: Initializing...');
        ...
        console.log('✓ Alaska Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Alaska voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='02'",  // Filter to Alaska only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Alaska districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Alaska Voting Districts</div>
