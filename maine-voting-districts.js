// Maine Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Maine Voting Districts: Initializing...');
        ...
        console.log('✓ Maine Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Maine
        map = L.map('vde-map', {
        ...
        // Add Maine voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='23'",  // Filter to Maine only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Maine districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Maine Voting Districts</div>
