// Connecticut Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Connecticut Voting Districts: Initializing...');
        ...
        console.log('✓ Connecticut Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Connecticut
        map = L.map('vde-map', {
        ...
        // Add Connecticut voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='09'",  // Filter to Connecticut only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Connecticut districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Connecticut</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Connecticut Voting Districts</div>
