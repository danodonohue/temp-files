// Kansas Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Kansas Voting Districts: Initializing...');
        ...
        console.log('✓ Kansas Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Kansas voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='20'",  // Filter to Kansas only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Kansas districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Kansas Voting Districts</div>
