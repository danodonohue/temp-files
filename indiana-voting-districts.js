// Indiana Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Indiana Voting Districts: Initializing...');
        ...
        console.log('✓ Indiana Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Indiana
        map = L.map('vde-map', {
        ...
        // Add Indiana voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='18'",  // Filter to Indiana only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Indiana districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Indiana</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Indiana Voting Districts</div>
