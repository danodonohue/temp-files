// Arkansas Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Arkansas Voting Districts: Initializing...');
        ...
        console.log('✓ Arkansas Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Arkansas
        map = L.map('vde-map', {
            center: [35.201, -91.8318],
            zoom: 7,
            minZoom: 5,
            maxZoom: 16
        });
        ...
        // Add Arkansas voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='05'",  // Filter to Arkansas only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Arkansas districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Arkansas</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Arkansas Voting Districts</div>
