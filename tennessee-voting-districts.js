// Tennessee Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Tennessee Voting Districts: Initializing...');
        ...
        console.log('✓ Tennessee Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Tennessee
        map = L.map('vde-map', {
        ...
        // Add Tennessee voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='47'",  // Filter to Tennessee only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Tennessee districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Tennessee</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Tennessee Voting Districts</div>
