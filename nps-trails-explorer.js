...
(function() {
    ...
    function setupEventListeners() {
        // Draw polygon button
        document.getElementById('nps-draw-polygon').addEventListener('click', function() {
            new L.Draw.Polygon(map, drawControl.options.draw.polygon).enable();
        });

        // Draw box button
        document.getElementById('nps-draw-box').addEventListener('click', function() {
            new L.Draw.Rectangle(map, drawControl.options.draw.rectangle).enable();
        });

        // Clear selection button
        document.getElementById('nps-clear-selection').addEventListener('click', clearSelection);
    ...
    function showTrailInfo(feature, layer) {
        ...
        const lengthKm = ((props.Shape__Length || 0) / 1000).toFixed(2);
        ...
        const popupContent = `
            <div class="nps-popup-content">
                ...
                <div class="nps-info-row">
                    ...
                    <span class="nps-value">${lengthKm} km</span>
                </div>
            </div>
        `;
