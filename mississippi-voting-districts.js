// Mississippi Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Mississippi Voting Districts: Initializing...');
        ...
        console.log('✓ Mississippi Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Mississippi
        map = L.map('vde-map', {
        ...
        // Add Mississippi voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='28'",  // Filter to Mississippi only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Mississippi districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Mississippi</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Mississippi Voting Districts</div>
