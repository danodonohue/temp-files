// Louisiana Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Louisiana Voting Districts: Initializing...');
        ...
        console.log('✓ Louisiana Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Louisiana
        map = L.map('vde-map', {
        ...
        // Add Louisiana voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='22'",  // Filter to Louisiana only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Louisiana districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Louisiana</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Louisiana Voting Districts</div>
