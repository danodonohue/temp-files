(function () {
  ...
  // Build paste section dynamically so no <textarea> appears in post_content HTML
  var pasteArea = document.createElement('textarea');
  pasteArea.id = 'gbg-paste-area';
  pasteArea.placeholder = 'Paste GeoJSON here...';
  var pasteActions = document.createElement('div');
  pasteActions.className = 'gbg-input-actions';
  var applyPasteBtn = document.createElement('button');
  applyPasteBtn.className = 'gbg-btn gbg-btn-primary gbg-btn-sm';
  ...
  pasteSampleBtn.className = 'gbg-btn gbg-btn-secondary gbg-btn-sm';
