// California Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';

    // Configuration
    const FEATURE_SERVICE_URL = 'https://services2.arcgis.com/FiaPA4ga0iQKduv3/arcgis/rest/services/Voting_Districts_v1/FeatureServer/0';
    const STATE_FIPS = '06';
    ...
    function initApp() {
        console.log('California Voting Districts: Initializing...');
        ...
        console.log('✓ California Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add California voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATEFP='06'",  // Filter to California only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
            onEachFeature: onEachDistrict,
            fields: ['OBJECTID', 'NAME', 'GEOID', 'STATEFP', 'COUNTY', 'VTD', 'POP100', 'AREALAND', 'FUNCSTAT']
        }).addTo(map);
        ...
        console.log('Map initialized with California districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading California Voting Districts</div>
