// Iowa Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Iowa Voting Districts: Initializing...');
        ...
        console.log('✓ Iowa Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Iowa
        map = L.map('vde-map', {
        ...
        // Add Iowa voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='19'",  // Filter to Iowa only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Iowa districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Iowa Voting Districts</div>
