// South Carolina Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('South Carolina Voting Districts: Initializing...');
        ...
        console.log('✓ South Carolina Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add South Carolina voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='45'",  // Filter to South Carolina only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with South Carolina districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> South Carolina</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading South Carolina Voting Districts</div>
