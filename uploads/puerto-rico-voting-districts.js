// Puerto Rico Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Puerto Rico Voting Districts: Initializing...');
        ...
        console.log('✓ Puerto Rico Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Puerto Rico voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='72'",  // Filter to Puerto Rico only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Puerto Rico districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Puerto Rico</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Puerto Rico Voting Districts</div>
