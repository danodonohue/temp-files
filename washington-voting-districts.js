// Washington Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Washington Voting Districts: Initializing...');
        ...
        console.log('✓ Washington Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Washington
        map = L.map('vde-map', {
        ...
        // Add Washington voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='53'",  // Filter to Washington only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Washington districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Washington</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Washington Voting Districts</div>
