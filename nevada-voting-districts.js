// Nevada Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Nevada Voting Districts: Initializing...');
        ...
        console.log('✓ Nevada Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Nevada
        map = L.map('vde-map', {
        ...
        // Add Nevada voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='32'",  // Filter to Nevada only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Nevada districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Nevada</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Nevada Voting Districts</div>
