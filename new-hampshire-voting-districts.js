// New Hampshire Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('New Hampshire Voting Districts: Initializing...');
        ...
        console.log('✓ New Hampshire Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on New Hampshire
        map = L.map('vde-map', {
        ...
        // Add New Hampshire voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='33'",  // Filter to New Hampshire only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with New Hampshire districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> New Hampshire</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading New Hampshire Voting Districts</div>
