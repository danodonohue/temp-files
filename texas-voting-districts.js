// Texas Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Texas Voting Districts: Initializing...');
        ...
        console.log('✓ Texas Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Texas voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='48'",  // Filter to Texas only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Texas districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Texas Voting Districts</div>
