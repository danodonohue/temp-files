// Illinois Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Illinois Voting Districts: Initializing...');
        ...
        console.log('✓ Illinois Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Illinois
        map = L.map('vde-map', {
        ...
        // Add Illinois voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='17'",  // Filter to Illinois only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Illinois districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Illinois Voting Districts</div>
