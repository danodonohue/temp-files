// Massachusetts Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Massachusetts Voting Districts: Initializing...');
        ...
        console.log('✓ Massachusetts Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Massachusetts voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='25'",  // Filter to Massachusetts only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Massachusetts districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Massachusetts</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Massachusetts Voting Districts</div>
