// Utah Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Utah Voting Districts: Initializing...');
        ...
        console.log('✓ Utah Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Utah voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='49'",  // Filter to Utah only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Utah districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Utah Voting Districts</div>
