// Idaho Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Idaho Voting Districts: Initializing...');
        ...
        console.log('✓ Idaho Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Idaho
        map = L.map('vde-map', {
        ...
        // Add Idaho voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='16'",  // Filter to Idaho only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Idaho districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Idaho Voting Districts</div>
