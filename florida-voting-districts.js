// Florida Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Florida Voting Districts: Initializing...');
        ...
        console.log('✓ Florida Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Florida voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='12'",  // Filter to Florida only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Florida districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Florida Voting Districts</div>
