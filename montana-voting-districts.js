// Montana Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Montana Voting Districts: Initializing...');
        ...
        console.log('✓ Montana Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on Montana
        map = L.map('vde-map', {
        ...
        // Add Montana voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='30'",  // Filter to Montana only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Montana districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Montana Voting Districts</div>
