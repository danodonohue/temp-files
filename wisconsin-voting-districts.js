// Wisconsin Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Wisconsin Voting Districts: Initializing...');
        ...
        console.log('✓ Wisconsin Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Wisconsin voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='55'",  // Filter to Wisconsin only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Wisconsin districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Wisconsin</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Wisconsin Voting Districts</div>
