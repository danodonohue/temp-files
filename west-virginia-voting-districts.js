// West Virginia Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('West Virginia Voting Districts: Initializing...');
        ...
        console.log('✓ West Virginia Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on West Virginia
        map = L.map('vde-map', {
        ...
        // Add West Virginia voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='54'",  // Filter to West Virginia only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with West Virginia districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading West Virginia Voting Districts</div>
