// South Dakota Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('South Dakota Voting Districts: Initializing...');
        ...
        console.log('✓ South Dakota Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on South Dakota
        map = L.map('vde-map', {
        ...
        // Add South Dakota voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='46'",  // Filter to South Dakota only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with South Dakota districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> South Dakota</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading South Dakota Voting Districts</div>
