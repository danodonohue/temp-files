// Oklahoma Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Oklahoma Voting Districts: Initializing...');
        ...
        console.log('✓ Oklahoma Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Oklahoma voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='40'",  // Filter to Oklahoma only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Oklahoma districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> Oklahoma</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Oklahoma Voting Districts</div>
