// Michigan Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Michigan Voting Districts: Initializing...');
        ...
        console.log('✓ Michigan Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Michigan voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='26'",  // Filter to Michigan only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Michigan districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Michigan Voting Districts</div>
