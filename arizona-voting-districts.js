// Arizona Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    function initApp() {
        console.log('Arizona Voting Districts: Initializing...');
        ...
        console.log('✓ Arizona Voting Districts initialized');
    }
    ...
    function initializeMap() {
        ...
        // Add Arizona voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='04'",  // Filter to Arizona only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with Arizona districts');
    }
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading Arizona Voting Districts</div>
