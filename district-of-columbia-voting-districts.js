// District of Columbia Voting Districts - Powered by esri-leaflet
(function() {
    'use strict';
    ...
    const STATE_FIPS = '11';
    const STATE_NAME = 'District of Columbia';
    ...
    function initApp() {
        console.log('District of Columbia Voting Districts: Initializing...');
        ...
        console.log('✓ District of Columbia Voting Districts initialized');
    }

    function initializeMap() {
        // Initialize map centered on District of Columbia
        map = L.map('vde-map', {
        ...
        // Set bounds to District of Columbia
        ...
        // Add District of Columbia voting districts layer
        districtLayer = L.esri.featureLayer({
            url: FEATURE_SERVICE_URL,
            where: "STATE='11'",  // Filter to District of Columbia only
            simplifyFactor: 0.75,
            precision: 4,
            style: styleDistrict,
        ...
        console.log('Map initialized with District of Columbia districts');
    }
    ...
    function showInfoPanel(feature) {
        ...
        panel.innerHTML = `
            ...
            <p><strong>State:</strong> District of Columbia</p>
...
${trackPoints}
    ...
    function showLoading() {
        ...
        loading.innerHTML = `
            ...
            <div class="vde-loading-text">Loading District of Columbia Voting Districts</div>
